...
1) το dataset_X οφείλει να είναι το ίδιο με αυτό που δόθηκε στο κυρίως πρόγραμμα για την εκπαίδευση του μοντέλου. Σε διαφορετική περίπτωση ενδέχεται να διαφοροποιηθεί το λεξιλόγιο και να υπάρξει αναντοιστιχία των βαρών που έχουν υπολογιστεί κατά την εκπαίδευση του μοντέλου.
